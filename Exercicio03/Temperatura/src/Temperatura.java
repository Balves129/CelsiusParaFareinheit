...
public class Temperatura {
    public static void main(String[] args) throws Exception {
        //Aqui temos a importação do Scanner, que serve para entrada de dados pelo teclado
        ...
        // A função nextLine() lê uma linha inteira do teclado até encontrar um caractere de nova linha ('\n')
        // A variável nomeUsuario é então atribuída o nome digitado pelo usuário sem espaços em branco
       
        String nomeUsuario = scanner.nextLine();
        RegistroUsuario Usuario = new RegistroUsuario(nomeUsuario);
        // A variável DadosRegistrados é uma lista de strings, que vai armazenar os dados de cada conversão
        ...
        // O método getNome() é usado para retornar o nome do usuário registrado no objeto RegistroUsuario
        ...
        // O método add() é usado para adicionar um novo registro de conversão (em string) à lista DadosRegistrados
        // O método format() é usado para formatação do texto, que neste caso é para mostrar a temperatura em Fahrenheit com uma casa decimal ( %.1f°F)
        ...
        // O método forEach() é usado para percorrer cada elemento da lista e imprimir seu conteúdo
        // Informacoes é um objeto do tipo String, que contem todos os dados da minha lista
